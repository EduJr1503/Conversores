...
//  Conversores
//
//  Created by Eduardo Junior on 11/04/22.
//
    ...
    @IBAction func showNext(_ sender: UIButton) {
        switch lbUnit.text! {
            ...
            default:
                ...
                btUnit2 .setTitle("Farenheight", for: .normal)
        }
        convert(nil)
    }
    ...
    @IBAction func convert(_ sender: UIButton?) {
        ...
        func calcCurrency() {
            ...
            if btUnit1.alpha == 1.0 {
                ...
                lbResult.text = String(currency / 4.7)
            } else {
